...
public class Constants {
    ...
    public static final String PKG_MEDIA_PROVIDERS = "com.android.providers.media.module";
    public static final String PKG_MEDIA_PROVIDERS_GOOGLE = "com.google.android.providers.media.module";
}
